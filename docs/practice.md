...
12. Напишите пайплайн DVC для предобработки данных, обучения и тестирования модели. 
13. Напишите Dockerfile для предиктивного сервиса, с пояснениями и комментариями.  
